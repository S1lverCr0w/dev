...
local servers = { -- ... etc. See `:help lspconfig-all` for a list of all the pre-configured LSPs
	clangd = {},
	zls = {},
	-- -- gopls = {},
	pyright = {},
...
-- borrowed from github.com/LukeElrod/nvim/blob/master/after/plugin/lsp.lua
-- vim.lsp.enable("clangd")
-- vim.lsp.enable('ccls') -- clangd alternative (dealbreaker: no warning when the headers aren't used)
